...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_WHOLENUMBER = 4,                /* WHOLENUMBER  */
  YYSYMBOL_ROTATION = 5,                   /* ROTATION  */
  YYSYMBOL_6_ = 6,                         /* '+'  */
  YYSYMBOL_7_ = 7,                         /* '-'  */
  YYSYMBOL_8_ = 8,                         /* '*'  */
  YYSYMBOL_9_ = 9,                         /* '/'  */
...
static const char *const yytname[] =
{
  ...
  "WHOLENUMBER", "ROTATION", "'+'", "'-'", "'*'", "'/'", "'('", "')'",
  "'|'", "'^'", "'\\n'", "','", "'i'", "'j'", "'k'", "$accept", "start",
  "line", "expr", "num", YY_NULLPTR
};
...
{
      40,   -12,   -12,     0,    40,    40,    40,   -12,   -12,   -12,
      24,    -6,    69,     5,    29,    71,    -2,    53,   -12,     1,
     -12,    40,    40,    40,    40,     9,   -12,   -12,   -12,    10,
     -12,   -12,   -12,    71,    71,    17,    17,    29,   -12,    40,
     -12,    61,   -12
};
...
{
       5,    24,    23,     0,     0,     0,     0,    17,    18,    19,
       5,     0,     4,    16,     0,     8,     0,     0,     1,     0,
       2,     0,     0,     0,     0,     0,    20,    21,    22,     0,
       6,     7,     3,     9,    10,    11,    12,     0,    13,     0,
      14,     0,    15
};
...
{
      15,    16,    17,    29,    21,    22,    23,    24,    20,    30,
      14,    25,     1,     2,    38,    32,    37,    33,    34,    35,
      36,    26,    27,    28,    18,    39,    40,     1,     2,     3,
      25,     4,     1,     2,     5,    41,     6,    19,     0,     0,
       7,     8,     9,     1,     2,     3,     0,     4,     0,     0,
       5,     0,     6,     0,     0,     0,     7,     8,     9,    21,
      22,    23,    24,     0,     0,    31,    25,    21,    22,    23,
      24,     0,    42,     0,    25,    21,    22,    23,    24,    23,
      24,     0,    25,     0,    25
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,    14,     6,     7,     8,     9,    14,    11,
      10,    13,     3,     4,    25,    14,     7,    21,    22,    23,
      24,    16,    17,    18,     0,    15,    37,     3,     4,     5,
      13,     7,     3,     4,    10,    39,    12,    10,    -1,    -1,
      16,    17,    18,     3,     4,     5,    -1,     7,    -1,    -1,
      10,    -1,    12,    -1,    -1,    -1,    16,    17,    18,     6,
       7,     8,     9,    -1,    -1,    12,    13,     6,     7,     8,
       9,    -1,    11,    -1,    13,     6,     7,     8,     9,     8,
       9,    -1,    13,    -1,    13
};
...
{
       0,     3,     4,     5,     7,    10,    12,    16,    17,    18,
      20,    21,    22,    23,    10,    22,    22,    22,     0,    21,
      14,     6,     7,     8,     9,    13,    16,    17,    18,    23,
      11,    12,    14,    22,    22,    22,    22,     7,    23,    15,
      23,    22,    11
};
...
#line 1219 "y.tab.c"
  ...
  case 7: /* expr: '|' expr '|'  */
#line 78 "prob5.y"
                               {  (yyval.qtn) = newQuaternion(norm((yyvsp[-1].qtn)),0,0,0);   }
#line 1225 "y.tab.c"
    break;

  case 8: /* expr: '-' expr  */
#line 79 "prob5.y"
                          {  (yyval.qtn) = scalarTimesQuaternion(-1,(yyvsp[0].qtn));  }
#line 1231 "y.tab.c"
    break;
...
#line 1255 "y.tab.c"
  ...
  case 13: /* expr: expr '^' num  */
#line 84 "prob5.y"
                              {  (yyval.qtn) = power((yyvsp[-2].qtn),(yyvsp[0].num));  }
#line 1261 "y.tab.c"
    break;

  case 14: /* expr: expr '^' '-' num  */
#line 85 "prob5.y"
                                  {  (yyval.qtn) = inverse(power((yyvsp[-3].qtn),(yyvsp[0].num)));  }
#line 1267 "y.tab.c"
    break;

  case 15: /* expr: ROTATION '(' num ',' expr ')'  */
#line 86 "prob5.y"
...
#line 1315 "y.tab.c"
  ...
  case 23: /* num: WHOLENUMBER  */
#line 96 "prob5.y"
                                 {  (yyval.num) = (yyvsp[0].iValue);   }
#line 1321 "y.tab.c"
    break;
